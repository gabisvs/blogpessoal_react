...
function Cadastro() {
    ...
    // Redireciona para o Componeten Login (rota / login)
    function retornar() {
        navigate('/login')
    }
                ...
                <form onSubmit={cadastrarNovoUsuario} className='flex justify-center items-center flex-col w-2/3 gap-3' >
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <input
                            ...
                            id="foto"
                            name="foto"
                            placeholder="Insira um link para sua foto"
                            className="border-2 border-slate-700 rounded p-2"
                            value={usuario.foto}
                            onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)}
                        />
                    ...
                    <div className="flex justify-around w-full gap-8">
                        <button className='rounded text-white bg-sky-950
                  hover:bg-red-950  w-1/2 py-2'onClick={retornar} >
                            Cancelar
                        </button>
                        <button
                            type='submit'
                            className='rounded text-white bg-sky-600 
